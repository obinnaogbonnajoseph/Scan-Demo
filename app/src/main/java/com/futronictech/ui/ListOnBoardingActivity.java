...
public class ListOnBoardingActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_on_boarding);
        ...
        mAdapter = new ListAdapter(ListOnBoardingActivity.this,this);
        mRecyclerView.setAdapter(mAdapter);

        // Set up the swipe and refresh
        swipeAndRefresh();

        // Start the call method
        startCallMethod();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id) {
            case R.id.refresh_page:
                //TODO: Refresh implemented later;
                return true;
            default:
